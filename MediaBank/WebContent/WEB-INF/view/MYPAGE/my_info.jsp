...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			if(ch==true){
				$("#frm").prop('action', 'mypageUpdate.mypage');
			}else{
				alert("비밀번호를 확인 하십시오.");
			}
		});
		...
		<article class="join_info">
			<form id="frm" name="frm" method="post">
				...
				<table class="table table-striped">
					...
					<c:if test="${empty sessionScope.member.token}">
						<tr>
							<td><span>*</span>PW</td>
							<td>
					...
					<tr>
						<td>연락처</td>
						<td><input class="change" type="text" name="phone" value="${sessionScope.member.phone}"></td>
					</tr>
					<tr>
						<td><span>*</span>이메일</td>
						<td><input class="change" type="email" name="email" required="required" value="${sessionScope.member.email}"></td>
					</tr>
					<tbody id="add"></tbody>
				</table>
				<div id="btn">
